...
final class APIService {
    ...
    // 메인화면 정보 조회  
    func retrieveMainData(data: String) async throws -> MainInfo? {
        do {
    ...
    private func makeRequest<T: Encodable>(to url: URL, method: HTTPMethod, with data: T?) throws -> URLRequest {
