//
//  WalkStartViewController.swift
//  DogRun
//
//  Created by 이규관 on 2024/02/08.
//
...
class WalkStartViewController: UIViewController {
...
// MARK: - click events
extension WalkStartViewController{
...
extension WalkStartViewController{
    ...
    private func setConstraints(){
        ...
        button1.snp.makeConstraints { make in
            ...
            make.width.equalTo(100) // 버튼의 너비 설정
            make.height.equalTo(50) // 버튼의 높이 설정
        }
